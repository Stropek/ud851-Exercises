...
class DatabaseTest {
    ...
    private val mDbHelperClass = WaitlistDbHelper::class.java
    ...
    fun create_database_test() {
        ...
        val tableNameCursor = database.rawQuery(
                "SELECT name FROM sqlite_master WHERE type='table' AND name='" +
                        WaitlistContract.WaitlistEntry.TABLE_NAME + "'", null)
    ...
    fun insert_single_record_test() {
        ...
        val wCursor = database.query(
                ...
                WaitlistContract.WaitlistEntry.TABLE_NAME, null, null, null, null, null, null)/* Columns; leaving this null returns every column in the table *//* Optional specification for columns in the "where" clause above *//* Values for "where" clause *//* Columns to group by *//* Columns to filter by row groups *//* Sort order to return in Cursor */
    ...
    internal fun deleteTheDatabase() {
        try {
            ...
            val f = mDbHelperClass.getDeclaredField("DATABASE_NAME")
            f.isAccessible = true
