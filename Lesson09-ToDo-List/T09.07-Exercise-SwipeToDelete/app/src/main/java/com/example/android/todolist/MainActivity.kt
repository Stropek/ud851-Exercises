    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ItemTouchHelper(object : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT or ItemTouchHelper.RIGHT) {
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, swipeDir: Int) {
                ...
                Toast.makeText(this@MainActivity, "deleted $deleted item with id $id", Toast.LENGTH_LONG).show()
         ...
         */
        supportLoaderManager.initLoader(TASK_LOADER_ID,
                null, this)
    }
    ...
    override fun onCreateLoader(id: Int, loaderArgs: Bundle?): Loader<Cursor> {
        ...
        return object : AsyncTaskLoader<Cursor>(this) {
            ...
            override fun loadInBackground(): Cursor? {
                ...
                try {
                    return contentResolver.query(TaskContract.TaskEntry.CONTENT_URI, null, null, null,
