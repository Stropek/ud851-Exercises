...
class TaskContentProvider : ContentProvider() {
    ...
    override fun query(uri: Uri, projection: Array<String>?, selection: String?,
        ...
        // Query for the tasks directory
            TASKS -> retCursor = db.query(TABLE_NAME,
                    projection,
                    selection,
    ...
    override fun delete(uri: Uri, selection: String, selectionArgs: Array<String>): Int {
        val readDatabase = mTaskDbHelper?.writableDatabase
        var deleted = 0
        ...
        when(sUriMatcher.match(uri)) {
            TASK_WITH_ID -> {
                ...
                deleted = readDatabase!!.delete(TABLE_NAME, "${TaskContract.TaskEntry._ID}=?", Array<String>(1) {id})
            }
            else -> throw UnsupportedOperationException("Unknown uri: $uri")
        }
