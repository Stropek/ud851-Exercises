...
class VisualizerActivity : AppCompatActivity(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private fun loadSizeFromPreferences(sharedPreferences: SharedPreferences) {
        val scale = sharedPreferences.getString(getString(R.string.pref_size_key),
                resources.getString(R.string.pref_size_value_default)).toFloat()
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences, key: String) {
        ...
        } else if (key == getString(R.string.pref_color_key)) {
            loadColorFromPreferences(sharedPreferences)
        } else if (key == getString(R.string.pref_size_key)) {
            loadSizeFromPreferences(sharedPreferences)
        }
    }
