...
class VisualizerActivity : AppCompatActivity(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private fun setupSharedPreferences() {
        ...
        sharedPreferences.registerOnSharedPreferenceChangeListener(this@VisualizerActivity)
    }
    ...
    override fun onDestroy() {
        super.onDestroy()
        PreferenceManager.getDefaultSharedPreferences(this@VisualizerActivity)
                .unregisterOnSharedPreferenceChangeListener(this@VisualizerActivity)
    }
