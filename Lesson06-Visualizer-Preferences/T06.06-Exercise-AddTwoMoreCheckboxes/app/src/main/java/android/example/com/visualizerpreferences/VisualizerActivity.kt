...
class VisualizerActivity : AppCompatActivity(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private fun setupSharedPreferences() {
        ...
        mVisualizerView!!.setShowMid(sharedPreferences.getBoolean(getString(R.string.pref_show_midrange_key),
                resources.getBoolean(R.bool.pref_show_midrange_default)))
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences, key: String) {
        when {
            key == getString(R.string.pref_show_bass_key) ->
                mVisualizerView!!.setShowBass(sharedPreferences.getBoolean(key, resources.getBoolean(R.bool.pref_show_bass_default)))
            key == getString(R.string.pref_show_midrange_key) ->
                mVisualizerView!!.setShowMid(sharedPreferences.getBoolean(key, resources.getBoolean(R.bool.pref_show_midrange_default)))
            key == getString(R.string.pref_show_treble_key) ->
